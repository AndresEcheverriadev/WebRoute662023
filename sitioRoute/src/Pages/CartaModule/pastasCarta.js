...
const pastas = [
  {
    nombre: "Mitico Filete Con Pasta A La Huancaina",
    texto:
      "Trozos de tierno filete bañados con nuestra espectacular salsa chifera, servidos con linguini a la huancaína.",
    img: `${pastas1}`,
    id: 1,
    top: true,
  },
  {
    nombre: "Encanto De Filete Con Gnocchi",
    texto:
      "Trozos de tierno filete, ñoquis, esparrago, pimentón, champiñones, queso parmesano, salsa de carne al vino tinto y ají panka.",
    img: `${pastas2}`,
    id: 2,
  },
  {
